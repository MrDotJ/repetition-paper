...
def get_load_min_max():
    min_load = [[800, 900, 800, 700, 800, 900, 800, 700, 800],
                [800, 600, 700, 800, 900, 800, 900, 800, 600]]
    max_load = [[1000, 1100, 1000, 900, 900, 1000, 900, 800, 1100],
...
def build_gas_network():
    ...
    gas_node_info = {
        'gas_node_num': 3,
        'node_pressure_min': [100, 100, 100],
        'node_pressure_max': [12000] * 3,
        'gas_well_num': 1,
        'well_index': [0],  # [0,0,4,5]
        'well_output_min': [0],
        'well_output_max': [10000000] * 1,
        'gas_load_num': 2,
        'load_index': [1, 2],
        'gas_load_min': (np.array(min_load)[:, 0: T]).tolist(),
        'gas_load_max': (np.array(max_load)[:, 0: T]).tolist(),
        'gen_gas_num': 0,
        'gen_gas_index': [],
        'gen_gas_min': [],
        'gen_gas_max': [],
    ...
    # gas node information
    gas_line_info = {
        'weymouth': wey[:2],  # for easy, it should contain all line(include active line)
        'gas_line_num': 2,
        'gas_line_start_point': [0, 1],  # gas flow out
        'gas_line_end_point': [1, 2],  # gas flow in
        'gas_line_pack_coefficient': pack[:2],
        'gas_line_pack_initial': 100,  # up 152.22 is feasible!
        'gas_line_active': [],
        'gas_flow_in_max': [2000000, 2000000],  # unused
        'gas_flow_out_max': [2000000, 2000000],  # unused
        'compressor_num': 0,
