...
def build_gas_network():
    ...
    gas_node_info = {
        ...
        'well_output_min': [0, 0],
        'well_output_max': [200, 200],
        'gas_load_num': 5,
        'load_index': [2, 3, 4, 5, 6],
    ...
    gas_line_info = {
        ...
        'weymouth': [1] * 6,
        'gas_line_num': 6,
        'gas_line_start_point': [0, 1, 2, 3, 4, 5],  # gas flow out
        'gas_line_end_point': [1, 2, 3, 4, 5, 6],  # gas flow in
        # 'gas_line_pack_coefficient': (np.array(pack) / 10).tolist(),
        'gas_line_pack_coefficient': [1] * 6,
        'gas_line_pack_initial': 20000,  # up 152.22 is feasible!
